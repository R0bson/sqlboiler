...
func TestMergeSet(t *testing.T) {
	...
	a := Set{
		Standard:   List{"fmt"},
		ThirdParty: List{"github.com/R0bson/sqlboiler", "github.com/volatiletech/null"},
	}
	b := Set{
		Standard:   List{"os"},
		ThirdParty: List{"github.com/R0bson/sqlboiler"},
	}
	...
	if c.ThirdParty[0] != "github.com/volatiletech/null" && c.ThirdParty[1] != "github.com/R0bson/sqlboiler" {
		t.Errorf("Wanted: github.com/R0bson/sqlboiler, github.com/volatiletech/null got: %#v", c.ThirdParty)
	}
}
